...
const categories = [
  ...
  { id: "carnes", label: "Carnes", icon: Bbq },
  { id: "acompanhamentos", label: "Acompanhamentos e sobremesas", icon: Chocolate },
  { id: "refrigerantes", label: "Refrigerantes", icon: CoffeeCup },
  { id: "cervejas", label: "Cervejas", icon: Sparks },
]
...
const menuItems = {
  frango: [
    ...
    },
    {
      ...
      description: "Coxa e sobrecoxa assadas, vendidas por unidade.",
      spiceLevel: 1,
      image: "/coxa.jpg",
    },
     {
      name: "Combo Completo",
      price: "R$ 54,99",
      description: "Frango assado, farofa, batata, 1 Refrigerante 1,5L",
      spiceLevel: 0,
      image: "/frango2.jpg",
    },
  ],
  bolos: [
    { name: "Bolo de Chocolate", price: "R$ 45,00", description: "Bolo de chocolate com cobertura de ganache e granulado", spiceLevel: 0, image: "https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=600&q=80" },
    { name: "Bolo de Cenoura com Brigadeiro", price: "R$ 42,00", description: "Bolo fofinho de cenoura com cobertura generosa de brigadeiro", spiceLevel: 0, image: "https://images.unsplash.com/photo-1621303837174-89787a7d4729?w=600&q=80" },
    { name: "Bolo de Leite Ninho", price: "R$ 50,00", description: "Bolo de baunilha recheado e coberto com creme de leite ninho", spiceLevel: 0, image: "https://images.unsplash.com/photo-1535141192574-5d4897c12636?w=600&q=80" },
    { name: "Bolo de Morango", price: "R$ 48,00", description: "Bolo branco com recheio e cobertura de morangos frescos e chantilly", spiceLevel: 0, image: "https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=600&q=80" },
    { name: "Bolo Red Velvet", price: "R$ 52,00", description: "Bolo red velvet com cream cheese e decoracao especial", spiceLevel: 0, image: "https://images.unsplash.com/photo-1616541823729-00fe0aacd32c?w=600&q=80" },
    { name: "Bolo no Pote (unidade)", price: "R$ 12,00", description: "Bolo no pote individual — varios sabores disponíveis", spiceLevel: 0, image: "https://images.unsplash.com/photo-1563729784474-d77dbb933a9e?w=600&q=80" },
  ],
  espetos: [
    { name: "Espeto de Carne Bovina", price: "R$ 12,00", description: "Espeto de carne bovina temperada na brasa", spiceLevel: 0, image: "/espeto_carne.png" },
    { name: "Espeto de Linguiça", price: "R$ 10,00", description: "Linguiça toscana suculenta assada na brasa", spiceLevel: 1, image: "/linguica.jpg", imagePosition: "object-bottom" },
    { name: "Espeto de Kafta", price: "R$ 12,00", description: "Kafta temperada com especiarias árabes grelhada no espeto", spiceLevel: 1, image: "espeto_kafta.png" },
    { name: "Espeto de Frango", price: "R$ 10,00", description: "Frango temperado e assado lentamente na brasa", spiceLevel: 0, image: "espeto_frango.png" },
    { name: "Pão de Alho", price: "R$ 7,00", description: "Baguete crocante com manteiga de alho e ervas", spiceLevel: 0, image: "/pao de alho.jpg" },
  ],
  drinks: [
  ...
  carnes: [
    {
      name: "Frango assado",
      price: "R$ 49,99",
      description: "Frango assado temperado e preparado na brasa.",
    },
    {
      name: "Coxa e sobrecoxa",
      price: "R$ 8,00/unidade",
    ...
    },
    {
      name: "Costela bovina",
      price: "R$ 75,00",
      description: "Costela bovina assada lentamente e bem temperada.",
    },
    {
      name: "Costela suína",
      price: "R$ 65,00",
      description: "Costela suína assada lentamente e bem temperada.",
    },
  ],
  acompanhamentos: [
    {
      name: "Torta de limão pequena",
      price: "R$ 45,00",
      description: "Torta de limão em tamanho pequeno.",
    },
    {
      name: "Torta de limão grande",
      price: "R$ 55,00",
      description: "Torta de limão em tamanho grande.",
    },
    {
      name: "Maionese",
      price: "R$ 15,00",
      description: "Acompanhamento cremoso para completar seu pedido.",
    },
    {
      name: "Farofa",
      price: "R$ 10,00",
      description: "Farofa saborosa para acompanhar as carnes.",
    },
  ],
  refrigerantes: [
    {
      ...
      price: "R$ 12,00",
      description: "Coca-Cola, garrafa de 2 litros.",
    },
    {
      name: "Sprite 2 litros",
      price: "R$ 12,00",
      description: "Sprite, garrafa de 2 litros.",
    },
    {
      name: "Fanta 2 litros",
      price: "R$ 12,00",
      description: "Fanta, garrafa de 2 litros.",
    },
    {
      name: "Guaraná 2 litros",
      price: "R$ 12,00",
      description: "Guaraná, garrafa de 2 litros.",
    },
    {
      name: "Convenção 2 litros",
      price: "R$ 8,00",
      description: "Convenção, garrafa de 2 litros.",
    },
    {
      name: "Tubaína 2 litros",
      price: "R$ 8,00",
      description: "Tubaína, garrafa de 2 litros.",
    },
    {
      name: "Dolly 2 litros",
      price: "R$ 8,00",
      description: "Dolly, garrafa de 2 litros.",
    },
    {
      name: "Fanta 1,5 litro",
      price: "R$ 8,00",
      description: "Fanta, garrafa de 1,5 litro.",
    },
    {
      name: "Guaraná 1,5 litro",
      price: "R$ 8,00",
      description: "Guaraná, garrafa de 1,5 litro.",
    },
    {
      name: "Pepsi 1,5 litro",
      price: "R$ 8,00",
      description: "Pepsi, garrafa de 1,5 litro.",
    },
    {
      name: "Coca-Cola lata",
      price: "R$ 6,00",
    ...
    {
      name: "Outros refrigerantes em lata",
      price: "R$ 6,00",
      description: "Outras opções de refrigerante em lata.",
    },
  ],
  cervejas: [
    { name: "Original", price: "R$ 5,00", description: "Cerveja Original." },
    { name: "Brahma", price: "R$ 5,00", description: "Cerveja Brahma." },
    { name: "Petra", price: "R$ 5,00", description: "Cerveja Petra." },
    { name: "Império", price: "R$ 5,00", description: "Cerveja Império." },
    { name: "Heineken", price: "R$ 10,00", description: "Cerveja Heineken." },
    { name: "Budweiser", price: "R$ 9,00", description: "Cerveja Budweiser." },
    { name: "Spaten", price: "R$ 8,00", description: "Cerveja Spaten." },
  ],
}
...
export function MenuSection() {
  ...
  useEffect(() => {
    if (window.location.hash === "#bolos") setActiveCategory("bolos")
  }, [])
